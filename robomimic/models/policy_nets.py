...
class GMMActorNetwork(ActorNetwork):
    ...
    def __init__(
        ...
        Args:
            ...
            disable_transforms(bool): if True, disable all transforms of the distribution: no tanh-Gaussian or tanh on means
        ...
        assert not (use_tanh and disable_transforms)
    ...
    def forward_train(self, obs_dict, goal_dict=None):
        ...
        if not self.use_tanh and not self.disable_transforms:
