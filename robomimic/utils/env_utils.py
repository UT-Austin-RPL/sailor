...
def get_env_class(env_meta=None, env_type=None, env=None):
    ...
    elif env_type == EB.EnvType.CALVIN_TYPE:
...
def is_calvin_env(env_meta=None, env_type=None, env=None):
    """
    Determines whether the environment is a calvin environment. Accepts
    either env_meta, env_type, or env.
    """
    return check_env_type(type_to_check=EB.EnvType.CALVIN_TYPE, env_meta=env_meta, env_type=env_type, env=env)
